  ...
  return (
    <section className="py-6 bg-blue-600">
      <div className="mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
        <div className="flex flex-col justify-center lg:text-left text-white">
          <p className="mb-1 text-sm font-medium tracking-widest uppercase ">
            Mobile App
          </p>
          <h1 className="py-2 text-3xl text-white font-medium leading-tight title-font">
            Let join mobile platform of us
          </h1>
        </div>
        <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
          <button className="inline-flex items-center px-6 py-3 rounded-lg bg-white text-blue-600">
            <svg
          ...
          <button className="inline-flex items-center px-5 py-3 rounded-lg bg-white text-blue-600">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 50 50"
              className="fill-current w-7 h-7"
