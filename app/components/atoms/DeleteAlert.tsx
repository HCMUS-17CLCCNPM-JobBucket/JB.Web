...
export default function DeleteAlert({ callback }) {
  return (
    <div className="alert-shadow fixed top-1/2 left-1/2 z-50">
      <div className="shadow-xl rounded-2xl p-4 bg-white dark:bg-gray-800 w-64 m-auto">
