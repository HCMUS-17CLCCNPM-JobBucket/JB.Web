...
//         const info = res.data.data.filter((item) => item.id == props.id);
//         setHeaderInfo(info[0].users[1]);
//       }
//     };
...
//     .withUrl(process.env.url + "/hub/chat", {
...
//         .start()
//         .then(function () {
//           connection.invoke("Join").then(() => {
//             connection
//               .invoke("SendMessage", props.id, value)
//               .then(() => setValue(""));
//           });
//         })
//         .catch(function (err) {
...
//   const { chats, hasMore, loading, error } = useChat(
//     page,
//     user.token,
//     props.id,
//     setPage,
