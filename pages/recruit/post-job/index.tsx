...
import jobTypeOptions from "app/constants/jobType.json";
import Province from "app/constants/province.json";
...
export default function index() {
  ...
  const [category, setCategory] = useState({ value: 0, label: "" });
