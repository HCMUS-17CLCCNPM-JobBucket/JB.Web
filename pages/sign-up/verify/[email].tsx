...
export default function VerifyPage(props) {
  ...
  return (
    <div className=" h-[80vh] min-w-screen flex flex-col justify-center items-center">
      <Head>
        <title>Home | JobBucket</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
      </Head>

      <div className="max-w-xl p-8 text-center text-gray-800 bg-white shadow-2xl lg:max-w-3xl rounded-3xl lg:p-12">
        <h3 className="text-2xl">Thanks for signing up for JobBucket!</h3>
        ...
        <p>
          ...
          We've sent verification code. Let's get your email address verified:
        </p>
        <form onSubmit={formik.handleSubmit} className="mt-4 flex gap-2">
          <input
            id="code"
            name="code"
          ...
          <button
            type="submit"
            className="px-2 py-2 text-blue-200 bg-blue-600 rounded-lg"
          >
