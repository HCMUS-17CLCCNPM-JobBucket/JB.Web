// import reportAPI from "app/api/modules/report";
...
export default function Contact() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      // const res = await reportAPI.getTags(user.token);
      // if (res.status === 200) {
  ...
  const sendReport = async () => {
    // const res = await reportAPI.report(user.token, {
    //   content,
    //   tagIds: value.map((item) => item.value),
    // });
    // if (res.status === 200)
    //   dispatch(
    //     actions.createAlert({
  ...
  return (
    <div className="dark:bg-gray-900 sm:px-16 ">
      <Head>
        <title>Report issues | JobBucket</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
      </Head>
      <div className="mt-10 max-w-screen-xl dark:bg-gray-800 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
        <div className="flex flex-col justify-between">
          <h2 className="text-4xl lg:text-5xl dark:text-white font-bold leading-tight">
        ...
        <div className="">
          <div className="mt-8">
            <span className="uppercase text-sm text-gray-600 dark:text-gray-400 font-bold">
              Tag
            </span>
            {/* <input
